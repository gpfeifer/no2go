 ...
 * @author Yaniv Inbar
 */
public final class LocalJettyReciever implements VerificationCodeReceiver {
   ...
   */
  LocalJettyReciever(String host, int port) {
    this.host = host;
    this.port = port;
  }
  ...
  public static final class Builder {
    ...
    /** Builds the {@link LocalJettyReciever}. */
    public LocalJettyReciever build() {
      return new LocalJettyReciever(host, port);
    }
